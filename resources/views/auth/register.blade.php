...
<main>
    <section id="register-form" class="bg-gray-100 bg-opacity-0 py-20">
        <div class="container mx-auto px-4 text-center">
            <form id="registrationForm" method="POST" action="{{ route('register') }}" class="bg-white shadow-lg rounded-lg p-8 max-w-2xl mx-auto">
                @csrf
                <h3 class="text-4xl font-bold mb-6">Register Your Account</h3>
